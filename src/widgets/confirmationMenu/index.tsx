...
export const ConfirmationMenu: FC<ConfirmationMenuProps> = ({ children, close, isFinish, h }) => {
  return (
    <BackgroundBlur close={close}>
      <div className={`bg-black px-4 pt-5 pb-8 h-auto rounded-t-3xl fixed bottom-0 left-0 right-0 z-50 ${h ? h : ''}`} onClick={(e) => e.stopPropagation()}>
