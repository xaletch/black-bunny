...
export const LoginTitle: FC<LoginTitleProps> = ({ icon, title, text, color, cl, cl_icon }) => {
  return (
    <div className={`flex items-center flex-col ${cl}`}>
      <div className={`w-[52px] h-[52px] flex items-center justify-center rounded-full ${color ? color : 'icon-bg'} ${cl_icon ? cl_icon : ''}`}>{icon}</div>
      <div className="mt-4">
