...
export const SnapItem: FC<SnapItemProp> = ({ min_name, icon, amount, value, rate, selected }) => {
  console.log(selected)
  return (
    <div className="mt-[6px] flex flex-col justify-between h-[77px]">
      <div className="flex justify-between">
        <div className="h-11 px-3 py-[6px] rounded-full bg-secondary-100 flex items-center justify-between gap-2">
